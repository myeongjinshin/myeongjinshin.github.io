---
layout: page
permalink: /quantum-algorithm-winter26/
title: Quantum Algorithm Lecture, Winter 2026
  ...
  <tbody>
    ...
    <tr style="background-color: #f9f9f9; color:black;">
      ...
      <td style="border: 1px solid #ccc;">
        ...
        <ul>
          <li><a href="https://arxiv.org/pdf/2509.19966">[Par'25] No Quantum Advantage in Decoded Quantum Interferometry for MaxCut</a></li>
        </ul>
      </td>
    </tr>
    <tr style="background-color: #f9f9f9; color:black;">
      ...
      <td style="border: 1px solid #ccc;">
        <ul>
          <li><a href="https://arxiv.org/pdf/2509.14509">[AGZ'25] Decoded Quantum Interferometry Requires Structure</a></li>
        </ul>
      </td>
    </tr>
    <tr>
